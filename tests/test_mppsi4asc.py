...
class TestMP_Psi4_ASC(TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        TestMP_Psi4_ASC.output_directory = os.path.join(TestMP_Psi4_ASC.CURR_DIR, "resources/test_output")
        if os.path.exists(TestMP_Psi4_ASC.output_directory):
            shutil.rmtree(TestMP_Psi4_ASC.output_directory)
        os.mkdir(TestMP_Psi4_ASC.output_directory)

        h5_file_original = os.path.join(TestMP_Psi4_ASC.CURR_DIR,
                                        "resources/D2.33_q1_a1_0_0_0_a2_0_0_0_m42.67.h5")
        os.mkdir(os.path.join(TestMP_Psi4_ASC.CURR_DIR, "resources/temp"))
        shutil.copy2(h5_file_original, os.path.join(TestMP_Psi4_ASC.CURR_DIR, "resources/temp"))

    @classmethod
    def tearDownClass(cls) -> None:
        shutil.rmtree(TestMP_Psi4_ASC.output_directory)

        if os.path.exists(os.path.join(TestMP_Psi4_ASC.CURR_DIR, "resources/temp.h5")):
            os.remove(os.path.join(TestMP_Psi4_ASC.CURR_DIR, "resources/temp.h5"))

        if os.path.exists(os.path.join(TestMP_Psi4_ASC.CURR_DIR, "resources/temp")):
            shutil.rmtree(os.path.join(TestMP_Psi4_ASC.CURR_DIR, "resources/temp"))

    def test_store_radiative_data_from_filetype(self):
        from mayawaves.utils.postprocessingutils import _MP_Psi4_ASC
        from mayawaves.utils.postprocessingutils import _RadiativeFilenames

        # stitching together multiple outputs

        temp_h5_file = h5py.File(os.path.join(TestMP_Psi4_ASC.CURR_DIR, "resources/temp.h5"), 'w')
            ...
            'radiative': {
                _RadiativeFilenames.MP_PSI4_ASC: {
                    "mp_Psi4r_l2_m2_r75.00.asc": [
                        os.path.join(TestMP_Psi4_ASC.CURR_DIR,
        ...
        _MP_Psi4_ASC.store_radiative_data_from_filetype(filepaths, psi4_group)

        expected_time, expected_real, expected_imag = np.loadtxt(
            os.path.join(TestMP_Psi4_ASC.CURR_DIR, "resources/outputs/stitched/mp_Psi4r_l2_m2_r75.00.asc"), unpack=True)

        expected_radius_keys = ["radius=75.00"]
        actual_radius_keys = sorted(list(psi4_group.keys()))
        self.assertEqual(expected_radius_keys, actual_radius_keys)

        r75_group = psi4_group["radius=75.00"]
        ...
        self.assertTrue(np.all(expected_real == actual_real_array))
        self.assertTrue(np.all(expected_imag == actual_imag_array))

        actual_time_array = r75_group["time"][()]
        self.assertTrue(np.all(expected_time == actual_time_array))
        ...
        filepaths = {
            'radiative': {
                _RadiativeFilenames.MP_PSI4_ASC: {
                    "mp_Psi4_l2_m2_r70.00.asc": [
                        os.path.join(TestMP_Psi4_ASC.CURR_DIR,
                                     "resources/sample_etk_simulations/qc0-mclachlan/output-0000/mp_Psi4_l2_m2_r70.00.asc")
                    ],
                    "mp_Psi4_l2_m1_r70.00.asc": [
                        os.path.join(TestMP_Psi4_ASC.CURR_DIR,
                                     "resources/sample_etk_simulations/qc0-mclachlan/output-0000/mp_Psi4_l2_m1_r70.00.asc")
                    ],
                    "mp_Psi4_l2_m2_r80.00.asc": [
                        os.path.join(TestMP_Psi4_ASC.CURR_DIR,
                                     "resources/sample_etk_simulations/qc0-mclachlan/output-0000/mp_Psi4_l2_m2_r80.00.asc")
                    ],
                    "mp_Psi4_l3_m3_r80.00.asc": [
                        os.path.join(TestMP_Psi4_ASC.CURR_DIR,
                                     "resources/sample_etk_simulations/qc0-mclachlan/output-0000/mp_Psi4_l3_m3_r80.00.asc")
                    ],
                }
            }
        }
    ...
    def test_get_header(self):
        ...
        m_value = -2
        radius = 120.00
        actual_header = _MP_Psi4_ASC.get_header(radius=radius, l_value=l_value, m_value=m_value)
    ...
    def test_export_radiative_data_to_ascii(self):
        ...
        psi4_data_dict = {}
        # l=2, m=2, r=70
        expected_file = os.path.join(TestMP_Psi4_ASC.CURR_DIR,
                                     'resources/sample_etk_simulations/qc0-mclachlan/output-0000/mp_Psi4_l2_m2_r70.00.asc')
        ...
        _MP_Psi4_ASC.export_radiative_data_to_ascii(psi4_data_dict=psi4_data_dict,
                                                    coalescence_output_directory=TestMP_Psi4_ASC.output_directory)

        # l=2, m=2, r=70
        generated_file = os.path.join(TestMP_Psi4_ASC.output_directory, 'mp_Psi4_l2_m2_r70.00.asc')
        ...
        # l=3, m=3, r=80
        generated_file = os.path.join(TestMP_Psi4_ASC.output_directory, 'mp_Psi4_l3_m3_r80.00.asc')
        self.assertTrue(os.path.isfile(generated_file))
